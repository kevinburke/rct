...
var TS_MAP = map[SegmentType]*Segment{
	...
	ELEM_RIGHT_FLYER_TWIST_UP_TO_DOWN: &Segment{
		Type:           0xbc,
		InputDegree:    TRACK_NONE,
		OutputDegree:   TRACK_NONE,
		StartingBank:   TRACK_BANK_NONE,
	...
	ELEM_LEFT_FLYER_TWIST_DOWN_TO_UP: &Segment{
		Type:           0xbd,
		InputDegree:    TRACK_NONE,
		OutputDegree:   TRACK_NONE,
		StartingBank:   TRACK_BANK_NONE,
	...
	ELEM_RIGHT_FLYER_TWIST_DOWN_TO_UP: &Segment{
		Type:           0xbe,
		InputDegree:    TRACK_NONE,
		OutputDegree:   TRACK_NONE,
		StartingBank:   TRACK_BANK_NONE,
	...
	ELEM_FLYER_HALF_LOOP_UP: &Segment{
		Type:           0xbf,
		InputDegree:    TRACK_UP_25,
		OutputDegree:   TRACK_NONE,
		StartingBank:   TRACK_BANK_NONE,
	...
	ELEM_FLYER_HALF_LOOP_DOWN: &Segment{
		Type:           0xc0,
		InputDegree:    TRACK_NONE,
		OutputDegree:   TRACK_DOWN_25,
		StartingBank:   TRACK_BANK_NONE,
	...
	ELEM_LEFT_FLY_CORKSCREW_UP_TO_DOWN: &Segment{
		Type:           0xc1,
		InputDegree:    TRACK_NONE,
		OutputDegree:   TRACK_NONE,
		StartingBank:   TRACK_BANK_NONE,
	...
	ELEM_HEARTLINE_TRANSFER_DOWN: &Segment{
		Type:           0xc6,
		InputDegree:    TRACK_NONE,
		OutputDegree:   TRACK_NONE,
		StartingBank:   TRACK_BANK_NONE,
	...
	ELEM_LEFT_HEARTLINE_ROLL: &Segment{
		Type:           0xc7,
		InputDegree:    TRACK_NONE,
		OutputDegree:   TRACK_NONE,
		StartingBank:   TRACK_BANK_NONE,
	...
	ELEM_RIGHT_HEARTLINE_ROLL: &Segment{
		Type:           0xc8,
		InputDegree:    TRACK_NONE,
		OutputDegree:   TRACK_NONE,
		StartingBank:   TRACK_BANK_NONE,
	...
	ELEM_AIR_THRUST_TOP_CAP: &Segment{
		Type:           0xd5,
		InputDegree:    TRACK_UP_90,
		OutputDegree:   TRACK_DOWN_90,
		StartingBank:   TRACK_BANK_NONE,
	...
	ELEM_AIR_THRUST_VERTICAL_DOWN: &Segment{
		Type:           0xd6,
		InputDegree:    TRACK_DOWN_90,
		OutputDegree:   TRACK_DOWN_90,
		StartingBank:   TRACK_BANK_NONE,
	...
	ELEM_AIR_THRUST_VERTICAL_DOWN_TO_LEVEL: &Segment{
		Type:           0xd7,
		InputDegree:    TRACK_DOWN_90,
		OutputDegree:   TRACK_NONE,
		StartingBank:   TRACK_BANK_NONE,
	...
	ELEM_BANKED_LEFT_QUARTER_TURN_3_TILES_25_DEG_UP: &Segment{
		Type:           0xd9,
		InputDegree:    TRACK_UP_25,
		OutputDegree:   TRACK_UP_25,
		StartingBank:   TRACK_BANK_LEFT,
...
func (s *Segment) String() string {
	return strings.Replace(string(ElementNames[s.Type]), "ELEM_", "", 1)
}
